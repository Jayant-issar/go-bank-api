...
// this store will provide all functions to execute database quries indiviually and transcation
type Store struct {
	*Queries
	db *sql.DB
}
...
// TransferTxResult is the result of the Transfer trancation
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		//creating entry for ammount deduction
		...
		//creating entry for ammount addition
		...
		//TODO: update account balance logic
